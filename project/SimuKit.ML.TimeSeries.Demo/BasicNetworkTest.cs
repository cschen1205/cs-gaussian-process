...
namespace SimuKit.ML.TimeSeries.Demo
{
    ...
    public class BasicNetworkTest
    {
        ...
        public static int StartingYear = 1700;
        public static int WindowSize = 30;
        public static int TrainStart = WindowSize;
        public static int TrainEnd = 259;
        public static int EvaluateStart = 260;
        public static int EvaluateEnd = SUNSPOTS.Length - 1;

        /** 
         * This really should be lowered, I am setting it to a  
         * level here that will train in under a minute. 
         */
        public static double MAX_ERROR = 0.01;

        private static double[] _normalizedSunspots;
        private static double[] _closedLoopSunspots;

        public static void NormalizeSunspots(double lo, double hi)
        {
            NormalizeArray norm = new NormalizeArray { NormalizedLow = lo, NormalizedHigh = hi };
        ...
        public static void Predict(BasicNetwork network)
        {
